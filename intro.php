<div class="wrap">
	...
	<h3>Paso 1: creando el menú</h3>

	<p>Debemos crear un menú con los artículos en el orden que queremos que aparezcan. Una vez hecho, el sistema leerá este menú a la hora de crear la newsletter</p>
	
	
	<p><img src="<?php echo plugins_url( 'paso1.jpg', __FILE__ ); ?>" width="900" /></p>
